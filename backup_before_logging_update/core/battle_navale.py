...
def test_battle_navale_analyzer():
    ...
    logger.debug("TEST BATTLE NAVALE ANALYZER - MÉTHODE SIGNATURE")
    print("=" * 55)
    ...
    logger.info("Long Down Up Bar: {result_sierra.long_down_up_bar:.3f}")
    logger.info("Long Up Down Bar: {result_sierra.long_up_down_bar:.3f}")
    logger.info("Color Down Setting: {result_sierra.color_down_setting:.3f}")

    # Test règle d'or
    logger.info("\n🏆 TEST RÈGLE D'OR:")
    logger.info("Trend continuation: {result_sierra.trend_continuation:.2f}")
    logger.info("Golden rule status: {result_sierra.golden_rule_status.value}")
    ...
    logger.info("⚔️ MÉTHODE SIGNATURE OPÉRATIONNELLE !")
