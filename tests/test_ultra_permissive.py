...
from features.market_state_analyzer import MarketStateAnalyzer, MarketState
...
def test_ultra_permissive():
    """Test ultra-permissif pour atteindre 25-30%"""
    logger.info("🎯 TEST ULTRA-PERMISSIF - Objectif 25-30%")
    logger.info("=" * 60)
    ...
    # 2. Initialiser l'intégrateur en mode demo
    ...
    # 7. Analyse des raisons de rejet
    reject_reasons = {}
    for r in results:
        if not r['is_valid']:
            reason = r['reason']
