#!/usr/bin/env python3
"""
Test IB Gateway Simulated - MIA_IA_SYSTEM
=========================================

Test spécifique pour IB Gateway en mode simulé.

USAGE:
python scripts/test_ib_gateway_simulated.py
"""
...
def test_ib_gateway_simulated():
    """Test IB Gateway en mode simulé"""
    
    print("🚀 TEST IB GATEWAY SIMULATED")
    print("=" * 40)
    ...
    try:
        ...
        # 1. Connexion IB Gateway
        print("\n1️⃣ Connexion IB Gateway...")
        ib = IB()
        ...
        # 8. Résumé final
        print("\n" + "=" * 40)
        print("📊 RÉSUMÉ IB GATEWAY SIMULATED")
        print("=" * 40)
        print("✅ Connexion: OK")
        ...
        if ticker.marketPrice() or ticker.bid or ticker.ask:
            ...
            print("🎉 SUCCÈS ! IB Gateway fonctionne !")
        else:
