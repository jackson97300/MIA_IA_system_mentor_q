...
class OptimizedFeatureCalculator(FeatureCalculator):
    ...
    def calculate_all_features(self, 
        ...
        if sierra_patterns:
            ...
            prev_close = structure_data.get('prev_close', market_data.close) if structure_data else market_data.close
    ...
    def _calculate_band_proximity(self, price: float, upper_band: float, lower_band: float) -> float:
...
def create_optimized_feature_calculator(config: Optional[Dict[str, Any]] = None) -> OptimizedFeatureCalculator:
