# 🚀 MIA IA SYSTEM - Copie Dossier Quantower
# Script PowerShell pour copier le dossier Quantower
# Version: Production Ready v1.0

Write-Host "========================================" -ForegroundColor Blue
Write-Host "📁 COPIE DOSSIER QUANTOWER" -ForegroundColor Blue
Write-Host "========================================" -ForegroundColor Blue
Write-Host ""

# Vérifier que le dossier source existe
$sourcePath = "C:\Users\LILJACKS\OneDrive\Bureau\documents sur bureau\Quantower"
$destinationPath = "D:\MIA_SHARED\Quantower"
...
if (-not (Test-Path $sourcePath)) {
    ...
    Write-Host "💡 Le chemin peut varier selon votre configuration OneDrive" -ForegroundColor Yellow
...
Write-Host "📋 Contenu du dossier Quantower:" -ForegroundColor Cyan
...
$confirmation = Read-Host "Voulez-vous copier le dossier Quantower vers MIA_SHARED ? (O/N)"
...
Write-Host "   4. Configurer Quantower pour utiliser le dossier partagé" -ForegroundColor White
Write-Host ""
