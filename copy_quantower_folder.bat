@echo off
REM 🚀 MIA IA SYSTEM - Copie Dossier Quantower
REM Script batch pour copier le dossier Quantower
REM Version: Production Ready v1.0

echo ========================================
echo 📁 COPIE DOSSIER QUANTOWER
echo ========================================
echo.

REM Vérifier que le dossier source existe
set "SOURCE_PATH=C:\Users\LILJACKS\OneDrive\Bureau\documents sur bureau\Quantower"
set "DEST_PATH=D:\MIA_SHARED\Quantower"

if not exist "%SOURCE_PATH%" (
    echo ❌ Dossier source introuvable: %SOURCE_PATH%
    echo 💡 Vérifiez le chemin et réessayez
    echo 💡 Le chemin peut varier selon votre configuration OneDrive
    pause
    exit /b 1
)
...
echo 📋 Contenu du dossier Quantower:
dir "%SOURCE_PATH%" /b
echo.

REM Demander confirmation
set /p "CONFIRMATION=Voulez-vous copier le dossier Quantower vers MIA_SHARED ? (O/N): "
...
echo    4. Configurer Quantower pour utiliser le dossier partagé
echo.
