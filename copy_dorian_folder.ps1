# 🚀 MIA IA SYSTEM - Copie Dossier Dorian
# Script PowerShell pour copier le dossier de trading Dorian
# Version: Production Ready v1.0

Write-Host "========================================" -ForegroundColor Blue
Write-Host "📁 COPIE DOSSIER DORIAN" -ForegroundColor Blue
Write-Host "========================================" -ForegroundColor Blue
Write-Host ""

# Vérifier que le dossier source existe
$sourcePath = "D:\DERNIER CHARBOOK DE DORIAN"
$destinationPath = "D:\MIA_SHARED\DERNIER_CHARBOOK_DE_DORIAN"
...
$confirmation = Read-Host "Voulez-vous copier le dossier Dorian vers MIA_SHARED ? (O/N)"
