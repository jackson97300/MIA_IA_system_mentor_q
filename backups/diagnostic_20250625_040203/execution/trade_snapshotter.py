...
class TradeSnapshotter:
    ...
    def get_ml_training_data(self, min_trades: int = 50) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if len(completed_trades) < min_trades:
                logger.warning(f"Pas assez de trades pour ML training: {len(completed_trades)}/{min_trades}")
                return None
    ...
    def _calculate_performance_metrics(self, result_snapshot: TradeResultSnapshot) -> Dict[str, float]:
