# 🚀 MIA IA SYSTEM - Copie Complète du Système MIA
# Script PowerShell pour copier le système MIA complet
# Version: Production Ready v1.0

Write-Host "========================================" -ForegroundColor Blue
Write-Host "🚀 COPIE COMPLÈTE SYSTÈME MIA" -ForegroundColor Blue
Write-Host "========================================" -ForegroundColor Blue
Write-Host ""

# Vérifier que le dossier source existe
$sourcePath = "D:\MIA_IA_system"
$destinationPath = "D:\MIA_SHARED\MIA_IA_system"
...
Write-Host "📋 Contenu du dossier MIA_IA_system:" -ForegroundColor Cyan
...
$confirmation = Read-Host "Voulez-vous copier le système MIA COMPLET vers MIA_SHARED ? (O/N)"
...
Write-Host "⏱️  Cela peut prendre plusieurs minutes selon la taille du dossier" -ForegroundColor Yellow
Write-Host ""
...
Write-Host "   4. Configurer le démarrage automatique du bot" -ForegroundColor White
Write-Host ""
