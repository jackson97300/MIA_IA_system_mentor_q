...
# === FEATURE WEIGHTS CONFIGURATION (TECHNIQUE #2 - NOUVELLE RÉPARTITION) ===

CONFLUENCE_WEIGHTS = {
    'gamma_levels_proximity': 0.25,      # 25% - Options flow SpotGamma (réduit pour Elite)
    'volume_confirmation': 0.18,         # 18% - Order flow + volume (réduit pour Elite)
    ...
    'smart_money_strength': 0.10,        # 🆕 10% - TECHNIQUE #2 ELITE: Smart Money
