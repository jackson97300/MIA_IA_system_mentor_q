...
SCSFExport scsf_MIA_Chart_Dumper_Patched_VIX_Daily(SCStudyInterfaceRef sc)
{
  if (sc.SetDefaults)
  {
    ...
    sc.Input[20].SetInt(33);  // Forcer l'ID 33 (votre étude actuelle)

    // Mapping Subgraphs (corrigé selon Sierra Chart: SG6/7/1/12/10)
    ...
    sc.Input[23].Name = "NBCV SG - Ask Volume Bid Volume Difference";
