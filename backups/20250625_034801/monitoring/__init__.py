...
Composants :
- LiveMonitor : Surveillance temps réel du système
- PerformanceTracker : Suivi des métriques de performance
- HealthChecker : Vérification santé système
...
# Performance Tracker - Métriques performance
try:
...
def create_monitoring_system(config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
    """
    Crée un système de monitoring complet
...
def check_monitoring_availability() -> Dict[str, bool]:
    """Vérifie la disponibilité des composants monitoring"""
    return {
...
def test_monitoring_package():
    ...
    if LIVE_MONITOR_AVAILABLE:
        ...
        try:
            test_live_monitor()
            tests_passed += 1
            logger.info("\n✅ LiveMonitor: Test réussi")
        except Exception as e:
            logger.info("\n❌ LiveMonitor: Test échoué - {e}")
    ...
    if PERFORMANCE_TRACKER_AVAILABLE:
        ...
        try:
            test_performance_tracker()
            tests_passed += 1
            logger.info("PerformanceTracker: Test réussi")
        except Exception as e:
            logger.error("PerformanceTracker: Test échoué - {e}")
    ...
    if HEALTH_CHECKER_AVAILABLE:
        ...
        try:
            test_health_checker()
            tests_passed += 1
            logger.info("HealthChecker: Test réussi")
        except Exception as e:
            logger.error("HealthChecker: Test échoué - {e}")
    ...
    if ALERT_SYSTEM_AVAILABLE:
        ...
        try:
            test_alert_system()
            tests_passed += 1
            logger.info("AlertSystem: Test réussi")
        except Exception as e:
            logger.error("AlertSystem: Test échoué - {e}")
    ...
    if DISCORD_NOTIFIER_AVAILABLE:
        ...
        try:
            test_discord_notifier()
            tests_passed += 1
            logger.info("DiscordNotifier: Test réussi")
        except Exception as e:
            logger.error("DiscordNotifier: Test échoué - {e}")
...
# Pour compatibilité avec imports existants
if LIVE_MONITOR_AVAILABLE:
...
if __name__ == "__main__":
    ...
    logger.info("\n📈 Statut Monitoring: {status['health'].upper()}")
