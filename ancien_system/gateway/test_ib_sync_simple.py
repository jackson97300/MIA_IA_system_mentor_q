#!/usr/bin/env python3
"""
Test IB Sync Simple - MIA_IA_SYSTEM
===================================

Test synchrone simple pour éviter les conflits de boucles d'événements.

USAGE:
python scripts/test_ib_sync_simple.py
"""
...
def test_ib_sync_simple():
    """Test synchrone simple avec ib_insync"""
    
    print("🔧 TEST SYNC SIMPLE IBKR")
    print("=" * 35)
