...
class TrainingScriptManager:
    ...
    def train_from_snapshots(self,
        ...
        try:
            ...
            if session.validation_results:
                ...
                logger.info(
                    "  Production Ready: {'✅' if val_results.get('production_readiness', False) else '❌'}")
    ...
    def show_training_status(self, detailed: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                "🔧 Trainer actif: {'✅' if sys_status.get('trainer_active', False) else '❌'}")
            logger.info(
                "🔄 Apprentissage continu: {'✅' if sys_status.get('continuous_learning', False) else '❌'}")
