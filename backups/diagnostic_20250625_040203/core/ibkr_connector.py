...
class IBKRConnector:
    ...
    def place_order(self, symbol: str, action: str, quantity: int, 
        ...
        try:
            ...
            if success:
                ...
                logger.info(f"✅ Ordre placé: {order_id} {action} {quantity} {symbol} @ {order_type}")
                return order_id
            else:
    ...
    def _attempt_reconnection(self):
        ...
        try:
            ...
            logger.info(f"Tentative reconnexion {self.reconnection_attempts + 1}/{self.max_reconnection_attempts}")
