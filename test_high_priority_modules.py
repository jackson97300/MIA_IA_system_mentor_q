#!/usr/bin/env python3
"""
Test complet des 3 modules PRIORITÉ HAUTE
...
print("🧪 TESTS MODULES PRIORITÉ HAUTE")
print("=" * 60)
...
try:
    ...
    order_manager = OrderManager(mode="data_collection")
...
try:
    ...
    is_valid = validator.validate_market_data_quick if hasattr(validator, 'validate_market_data_quick') else lambda x: len(validator.validate_market_data(x)) == 0
    if callable(is_valid):
        quick_result = is_valid(valid_data)
        print(f"✅ Validation rapide: {quick_result}")
...
print("\n" + "=" * 60)
print("🎉 TESTS MODULES PRIORITÉ HAUTE TERMINÉS")
print("\n📊 RÉSUMÉ:")
