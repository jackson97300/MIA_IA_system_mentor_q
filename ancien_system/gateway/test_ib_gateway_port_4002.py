#!/usr/bin/env python3
"""
Test IB Gateway Port 4002 - MIA_IA_SYSTEM
=========================================

Test IB Gateway sur le port 4002.

USAGE:
python scripts/test_ib_gateway_port_4002.py
"""
...
def test_ib_gateway_port_4002():
    """Test IB Gateway sur le port 4002"""
    
    print("🚀 TEST IB GATEWAY PORT 4002")
    print("=" * 40)
    ...
    try:
        ...
        # 1. Connexion IB Gateway sur port 4002
        print("\n1️⃣ Connexion IB Gateway (Port 4002)...")
        ib = IB()
        ib.connect('127.0.0.1', 4002, clientId=1, timeout=10)
        
        if ib.isConnected():
            print("✅ Connexion IB Gateway Port 4002 OK")
        else:
            print("❌ Échec connexion IB Gateway Port 4002")
            return
        ...
        # 8. Résumé final
        print("\n" + "=" * 40)
        print("📊 RÉSUMÉ IB GATEWAY PORT 4002")
        print("=" * 40)
        print("✅ Connexion: OK")
        ...
        if ticker.marketPrice() or ticker.bid or ticker.ask:
            ...
            print("🎉 SUCCÈS ! IB Gateway Port 4002 fonctionne !")
        else:
