...
Structure:
---------
- ARCHITECTURE_MASTER.md : Document de référence principal
- IMPORTS_RULES.md : Guide des règles d'imports anti-erreurs
- architecture.md : Architecture technique détaillée
- automation_guide.md : Guide d'automation du trading
- data_collection_guide.md : Guide de collection des données
...
DOCUMENTATION_STRUCTURE = {
    'ARCHITECTURE_MASTER.md': {
        'title': 'Architecture Master - Document de Référence',
        'description': 'Vue complète de l\'architecture système avec règles d\'intégration',
        'topics': ['Architecture', 'Imports', 'Modules', 'Intégration', 'Workflow'],
        'audience': ['Tous développeurs'],
        'maintenance_frequency': 'Mensuelle'
    },
    'IMPORTS_RULES.md': {
        'title': 'Règles d\'Imports - Guide Anti-Erreurs',
        'description': 'Guide détaillé pour éviter tous problèmes d\'imports',
        'topics': ['Imports', 'Dépendances', 'Hiérarchie', 'Debugging'],
    ...
    'automation_guide.md': {
        ...
        'description': 'Configuration et utilisation du système d\'automation',
        'topics': ['Automation', 'Configuration', 'Monitoring', 'Safety'],
        'audience': ['Traders', 'DevOps'],
        'maintenance_frequency': 'Mensuelle'
    },
    'data_collection_guide.md': {
        'title': 'Guide Collection de Données',
        'description': 'Processus de collection et stockage des données de trading',
        'topics': ['Data Pipeline', 'Storage', 'Quality', 'Snapshots'],
        'audience': ['Data Engineers', 'ML Engineers'],
        'maintenance_frequency': 'Bi-mensuelle'
    },
    'ml_strategy.md': {
        'title': 'Stratégie ML Progressive',
        'description': 'Approche progressive pour l\'intégration du Machine Learning',
    ...
    'deployment_guide.md': {
        ...
        'description': 'Procédures pour déployer en environnement de production',
