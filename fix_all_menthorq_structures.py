...
# -*- coding: utf-8 -*-
"""
Script pour corriger TOUTES les structures MenthorQ dans les données de test
"""

import re

def fix_all_menthorq_structures():
    """Corrige toutes les structures MenthorQ dans le fichier de test"""
    ...
    # Pattern pour trouver TOUTES les structures MenthorQ avec listes
    # Ce pattern capture tout le bloc menthorq avec ses listes
    pattern = r"'menthorq': \{[^}]*'gamma_wall': \[[^\]]*\][^}]*'put_support': \[[^\]]*\][^}]*'hvl': \[[^\]]*\][^}]*'gex_levels': \[[^\]]*\][^}]*\}"
    ...
    print("✅ Toutes les structures MenthorQ corrigées dans les données de test")

if __name__ == "__main__":
    fix_all_menthorq_structures()
